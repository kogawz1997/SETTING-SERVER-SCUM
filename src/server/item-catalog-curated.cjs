const EXACT_ITEMS = {
  ...
  Weapon_AK47: {
    displayName: 'AK-47 rifle',
    displayNameEn: 'AK-47 rifle',
    displayNameTh: 'ปืน AK-47',
    category: 'weapon',
    rarity: 'rare',
    tags: ['weapon', 'rifle', 'assault-rifle', 'ak', 'military'],
  },
  Weapon_AK15: {
    displayName: 'AK-15 rifle',
    displayNameEn: 'AK-15 rifle',
    displayNameTh: 'ปืน AK-15',
    category: 'weapon',
    rarity: 'rare',
    tags: ['weapon', 'rifle', 'assault-rifle', 'ak', 'military'],
  },
  Weapon_M16A4: {
    displayName: 'M16A4 rifle',
    displayNameEn: 'M16A4 rifle',
    displayNameTh: 'ปืน M16A4',
    category: 'weapon',
    rarity: 'rare',
    tags: ['weapon', 'rifle', 'assault-rifle', 'military'],
  },
  Weapon_M82A1: {
    displayName: 'M82A1 sniper rifle',
    displayNameEn: 'M82A1 sniper rifle',
    displayNameTh: 'ปืนซุ่มยิง M82A1',
    category: 'weapon',
    rarity: 'very_rare',
    tags: ['weapon', 'sniper', 'anti-materiel', 'military', 'high-tier'],
  },
  Weapon_SVD_Dragunov: {
    displayName: 'SVD Dragunov sniper rifle',
    displayNameEn: 'SVD Dragunov sniper rifle',
    displayNameTh: 'ปืนซุ่มยิง SVD Dragunov',
    category: 'weapon',
    rarity: 'rare',
    tags: ['weapon', 'sniper', 'marksman', 'military'],
  },
  'Weapon_RPK-74': {
    displayName: 'RPK-74 light machine gun',
    displayNameEn: 'RPK-74 light machine gun',
    displayNameTh: 'ปืนกลเบา RPK-74',
    category: 'weapon',
    rarity: 'rare',
    tags: ['weapon', 'rifle', 'lmg', 'military'],
  },
  Weapon_MP5: {
    displayName: 'MP5 submachine gun',
    displayNameEn: 'MP5 submachine gun',
    displayNameTh: 'ปืนกลมือ MP5',
    category: 'weapon',
    rarity: 'uncommon',
    tags: ['weapon', 'smg', 'police', 'military'],
  },
  Weapon_Block21: {
    displayName: 'Block 21 pistol',
    displayNameEn: 'Block 21 pistol',
    displayNameTh: 'ปืนพก Block 21',
    category: 'weapon',
    rarity: 'uncommon',
    tags: ['weapon', 'pistol', 'sidearm'],
  },
  Weapon_HS9: {
    displayName: 'HS9 pistol',
    displayNameEn: 'HS9 pistol',
    displayNameTh: 'ปืนพก HS9',
    category: 'weapon',
    rarity: 'common',
    tags: ['weapon', 'pistol', 'sidearm'],
  },
  Weapon_M1911: {
    ...
    displayNameEn: 'M1911 pistol',
    displayNameTh: 'ปืนพก M1911',
    category: 'weapon',
    rarity: 'uncommon',
    tags: ['weapon', 'pistol', 'sidearm'],
  },
  Weapon_Hunter85_V2: {
    displayName: 'Hunter 85 rifle',
    displayNameEn: 'Hunter 85 rifle',
    displayNameTh: 'ปืนล่าสัตว์ Hunter 85',
    category: 'weapon',
    rarity: 'uncommon',
    tags: ['weapon', 'rifle', 'hunting'],
  },
  Weapon_CarbonHunter: {
    displayName: 'Carbon Hunter rifle',
    displayNameEn: 'Carbon Hunter rifle',
    displayNameTh: 'ปืนล่าสัตว์ Carbon Hunter',
    category: 'weapon',
    rarity: 'rare',
    tags: ['weapon', 'rifle', 'hunting'],
  },
  Cal_5_56x45mm_Ammobox: {
    displayName: '5.56x45mm ammo box',
    displayNameEn: '5.56x45mm ammo box',
    displayNameTh: 'กล่องกระสุน 5.56x45mm',
    category: 'ammo',
    rarity: 'uncommon',
    tags: ['ammo', 'rifle-ammo', '5.56', 'military'],
  },
  Cal_7_62x39mm_Ammobox: {
    displayName: '7.62x39mm ammo box',
    displayNameEn: '7.62x39mm ammo box',
    displayNameTh: 'กล่องกระสุน 7.62x39mm',
    category: 'ammo',
    rarity: 'uncommon',
    tags: ['ammo', 'rifle-ammo', '7.62', 'ak'],
  },
  Cal_50BMG_Ammobox: {
    displayName: '.50 BMG ammo box',
    displayNameEn: '.50 BMG ammo box',
    displayNameTh: 'กล่องกระสุน .50 BMG',
    category: 'ammo',
    rarity: 'very_rare',
    tags: ['ammo', 'sniper-ammo', '50bmg', 'high-tier'],
  },
  Adrenaline_Shot: {
    displayName: 'Adrenaline shot',
    displayNameEn: 'Adrenaline shot',
    displayNameTh: 'เข็มอะดรีนาลีน',
    category: 'medical',
    rarity: 'rare',
    tags: ['medical', 'emergency', 'stimulant'],
  },
  Canteen: {
    displayName: 'Canteen',
    displayNameEn: 'Canteen',
    displayNameTh: 'กระติกน้ำ',
    category: 'food',
    rarity: 'uncommon',
  ...
  Car_Battery: {
    ...
    displayNameEn: 'Car battery',
    displayNameTh: 'แบตเตอรี่รถ',
    category: 'vehicle',
    rarity: 'uncommon',
    tags: ['vehicle', 'battery', 'repair', 'garage'],
  },
  Car_Battery_Cables: {
    displayName: 'Car battery cables',
    displayNameEn: 'Car battery cables',
    displayNameTh: 'สายพ่วงแบตเตอรี่รถ',
    category: 'vehicle',
    rarity: 'common',
    tags: ['vehicle', 'battery', 'repair', 'garage'],
  },
  Laika_Engine_Alternator_Item: {
    displayName: 'Laika alternator',
    displayNameEn: 'Laika alternator',
    displayNameTh: 'ไดชาร์จ Laika',
    category: 'vehicle',
    rarity: 'rare',
    tags: ['vehicle', 'engine', 'alternator', 'repair'],
  },
  Magazine_AK47: {
