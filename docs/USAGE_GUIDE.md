...
ใน P2.5 หน้านี้เพิ่มตัวช่วยอ่านค่า:
...
- ถ้าข้อมูลยาว ให้ใช้ search/filter, เปิดเฉพาะ row ที่แก้ และซ่อน Files/Inspector ได้
...
ใน P2.5 กล่อง `ควรทำต่อ / Next actions` ไม่ได้เป็นแค่ข้อความแล้ว:
